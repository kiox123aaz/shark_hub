...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Shark  Hub BF') then
        makefolder('Shark  Hub BF')
    end
    if not _G.Dis and not isfile('Shark  Hub BF/'..Name..'.json') then
        writefile('Shark  Hub BF/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Shark  Hub BF') and isfile('Shark  Hub BF/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Shark  Hub BF/'..Name..'.json'))
